...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final user = context.read<FirebaseAutMethode>().user;
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          CustomButton(
            onTap: () {
              context.read<FirebaseAutMethode>().signOut(context);
            },
            text: 'Sign Out',
          ),
          CustomButton(
            onTap: () {
              context.read<FirebaseAutMethode>().deleteAccount(context);
            },
            text: 'Delete Account',
          ),
        ],
